import {TAB_ADD, TAB_REMOVE_ACTIVE, TAB_SWITCH, TAB_TITLE_UPDATE} from '../actions/tab';
  ...
  describe('titleReducer', () => {
    describe(TAB_TITLE_UPDATE, () => {
      it('should update the title of a tab', () => {
        const newTitle: string = titleReducer('old title', {type: TAB_TITLE_UPDATE, payload: {newTitle: 'new title'}});
